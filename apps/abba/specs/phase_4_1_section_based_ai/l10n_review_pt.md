# Phase 4.1 L10n Review — Portuguese (`pt`)

> **Target reviewer**: native Portuguese speaker, ideally familiar with
> Christian devotional register for senior readers (50-70).

**Register notes**: BR + PT audiences; watch tu/você register
...
— a maintainer will apply it to `apps/abba/lib/l10n/app_pt.arb`.

## Source of truth

- English baseline: `apps/abba/lib/l10n/app_en.arb`
- Korean reference: `apps/abba/lib/l10n/app_ko.arb`
- File under review: `apps/abba/lib/l10n/app_pt.arb`
...
- **KO**: 이 말씀은 잠시 후 준비됩니다...
- **PT**: Preparando esta passagem para você...
...
- **PT**: Enquanto preparamos sua análise completa...
...
- **PT**: Em breve, volte a verificar mais tarde
...
- **PT**: Preparando seu conteúdo premium...
...
- **KO**: 깊은 묵상이 곧 나타날 거예요
- **PT**: Sua reflexão profunda aparecerá aqui
...
- **KO**: 부분 완성 (계속 진행 중)
- **PT**: Análise parcial (mais a caminho)
