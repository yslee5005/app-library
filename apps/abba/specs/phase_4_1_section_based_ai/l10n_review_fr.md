# Phase 4.1 L10n Review — French (`fr`)

> **Target reviewer**: native French speaker, ideally familiar with
> Christian devotional register for senior readers (50-70).

**Register notes**: Post–Vatican II `tu` toward God is standard
...
— a maintainer will apply it to `apps/abba/lib/l10n/app_fr.arb`.

## Source of truth

- English baseline: `apps/abba/lib/l10n/app_en.arb`
- Korean reference: `apps/abba/lib/l10n/app_ko.arb`
- File under review: `apps/abba/lib/l10n/app_fr.arb`
...
- **KO**: 당신의 기도를 묵상하고 있어요...
- **FR**: Nous méditons sur votre prière...
...
- **FR**: D'autres réflexions arrivent...
...
- **KO**: 오늘의 말씀을 찾고 있어요...
- **FR**: Nous cherchons le bon passage...
...
- **KO**: 이 말씀은 잠시 후 준비됩니다...
- **FR**: Nous préparons ce passage pour vous...
...
- **FR**: Pendant que nous préparons votre analyse complète...
...
- **FR**: Bientôt disponible, revenez plus tard
...
- **FR**: Nous créons d'autres réflexions...
...
- **FR**: Nous préparons votre contenu premium...
...
- **KO**: 깊은 묵상이 곧 나타날 거예요
- **FR**: Votre réflexion profonde apparaîtra ici
...
- **EN**: For Work & Studies
- **KO**: 일과 공부를 위한 묵상
- **FR**: Pour le travail et les études
...
- **KO**: 부분 완성 (계속 진행 중)
- **FR**: Analyse partielle (suite à venir)
