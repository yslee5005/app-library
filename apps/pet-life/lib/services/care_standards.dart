    ...
    CareCategory(
      ...
      items: [
        ...
        CareItem(
          ...
          tip:
              '${breed?.name ?? "강아지"}는 하루 $_recommendedDailyWalkMinutes분 산책 권장',
          source: 'AKC by breed',
    ...
    CareCategory(
      ...
      items: [
        ...
        CareItem(
          ...
          tip: _isSenior ? '시니어는 연 2회 건강검진 필수예요' : '연 1회 건강검진을 권장해요',
    ...
    CareCategory(
      ...
      items: [
        ...
        CareItem(
          ...
          tip:
              '체중 1kg당 50-60ml 권장. ${profile.name}는 하루 ${(profile.weightKg * 55).round()}ml',
...
class CareItem {
  ...
  final String source;
  final String?
  routineCategory; // if linked to a routine category for auto-counting
