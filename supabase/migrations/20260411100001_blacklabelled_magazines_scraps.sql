...
-- 3. Seed: 기존 매거진 데이터 (3개)
INSERT INTO blacklabelled.magazines (tenant_id, title, summary, thumbnail_url, date)
SELECT t.id,
  '2026 인테리어 트렌드',
  '올해 주목해야 할 인테리어 키워드를 정리했습니다. 미니멀리즘의 진화, 바이오필릭 디자인, 커브드 퍼니처 등 전문가가 선정한 트렌드를 만나보세요.',
  'https://www.blacklabelled.co.kr/web/product/medium/202603/afae5563ffb38b23820cdfe47e574684.jpg',
  '2026-04-01'
...
SELECT t.id,
  ...
  'https://www.blacklabelled.co.kr/web/product/medium/202603/44f697f0b99ab1e42a33d6ee03d88fe4.jpg',
  '2026-03-15'
FROM public.tenants t WHERE t.slug = 'blacklabelled';
...
SELECT t.id,
  ...
  'https://www.blacklabelled.co.kr/web/product/medium/202603/09af532a1f13b50e9f486add3c0dcd56.jpg',
  '2026-02-20'
FROM public.tenants t WHERE t.slug = 'blacklabelled';
